...
class RSAKeyTest(unittest.TestCase):
    def setUp(self):
        with open('fixtures/private.pem', 'r') as f:
            self.private_key = rsa_key.RSAPrivateKey.from_pem(f.read())
        with open('fixtures/public.pem', 'r') as f:
    ...
    def test_key_id(self):
        ...
        self.assertEqual(pubkey_key_id, 'IIYO:OWAZ:MBMG:2SIK:IK2I:OP5Z:H6QR:KN6Y:QUGO:BUWN:TYW3:JXVW')
